...
> connect to, read/write, and diagnose Modbus TCP / Modbus RTU over TCP / FINS / MELSEC / Siemens S7comm / IEC 60870-5-104 / EtherNet/IP (CIP) devices.
...
| EtherNet/IP | CIP tag write (0x4D); integers default DINT, floats need explicit `options.type="REAL"` | `point_type="tag"`, `options.type` |
