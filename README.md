...
> Modbus TCP / Modbus RTU over TCP / FINS / MELSEC / Siemens S7comm / IEC 60870-5-104 / EtherNet/IP (CIP) PLC 的 MCP Server。
...
**状态: v0.5.3 (协议自动识别 + 透明代理 + 故障注入监听 + 七协议端点读写; IEC 104 经 lib60870、EtherNet/IP 经 pycomm3 官方实现交叉验证)。**
